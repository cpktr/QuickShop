...
namespace QuickShop {
	...
	private: System::Windows::Forms::TextBox^ txt_typeUser;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->txt_typeUser = (gcnew System::Windows::Forms::TextBox());
			...
			// panel5
			// 
			this->panel5->Controls->Add(this->txt_typeUser);
			...
			// txt_typeUser
			// 
			this->txt_typeUser->Location = System::Drawing::Point(158, 4);
			this->txt_typeUser->Name = L"txt_typeUser";
			this->txt_typeUser->Size = System::Drawing::Size(100, 20);
			this->txt_typeUser->TabIndex = 1;
			// 
			// label5
			// 
